...
2. Install the Kernal (This step only needs to be done once)
    Command: 'python -m ipykernel install --user --name=myenv --display-name "AML-Assignment-2-2"'
3. Navigate to main.ipynb
4. Click on "Select Kernal" and select "AML-Assignment-2"
5. Run the main.ipynb
